...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.VaultEnvAuth)(nil), (*certmanager.VaultEnvAuth)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_VaultEnvAuth_To_certmanager_VaultEnvAuth(a.(*v1.VaultEnvAuth), b.(*certmanager.VaultEnvAuth), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*certmanager.VaultEnvAuth)(nil), (*v1.VaultEnvAuth)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_certmanager_VaultEnvAuth_To_v1_VaultEnvAuth(a.(*certmanager.VaultEnvAuth), b.(*v1.VaultEnvAuth), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_certmanager_VaultAuth_To_v1_VaultAuth(in *certmanager.VaultAuth, out *v1.VaultAuth, s conversion.Scope) error {
	...
	out.Env = (*v1.VaultEnvAuth)(unsafe.Pointer(in.Env))
	return nil
}
...
func autoConvert_v1_VaultEnvAuth_To_certmanager_VaultEnvAuth(in *v1.VaultEnvAuth, out *certmanager.VaultEnvAuth, s conversion.Scope) error {
	out.Path = in.Path
	out.AdditionalData = *(*map[string]string)(unsafe.Pointer(&in.AdditionalData))
	return nil
}

// Convert_v1_VaultEnvAuth_To_certmanager_VaultEnvAuth is an autogenerated conversion function.
func Convert_v1_VaultEnvAuth_To_certmanager_VaultEnvAuth(in *v1.VaultEnvAuth, out *certmanager.VaultEnvAuth, s conversion.Scope) error {
	return autoConvert_v1_VaultEnvAuth_To_certmanager_VaultEnvAuth(in, out, s)
}

func autoConvert_certmanager_VaultEnvAuth_To_v1_VaultEnvAuth(in *certmanager.VaultEnvAuth, out *v1.VaultEnvAuth, s conversion.Scope) error {
	out.Path = in.Path
	out.AdditionalData = *(*map[string]string)(unsafe.Pointer(&in.AdditionalData))
	return nil
}

// Convert_certmanager_VaultEnvAuth_To_v1_VaultEnvAuth is an autogenerated conversion function.
func Convert_certmanager_VaultEnvAuth_To_v1_VaultEnvAuth(in *certmanager.VaultEnvAuth, out *v1.VaultEnvAuth, s conversion.Scope) error {
	return autoConvert_certmanager_VaultEnvAuth_To_v1_VaultEnvAuth(in, out, s)
}
