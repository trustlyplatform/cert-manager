...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*VaultEnvAuth)(nil), (*certmanager.VaultEnvAuth)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_VaultEnvAuth_To_certmanager_VaultEnvAuth(a.(*VaultEnvAuth), b.(*certmanager.VaultEnvAuth), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*certmanager.VaultEnvAuth)(nil), (*VaultEnvAuth)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_certmanager_VaultEnvAuth_To_v1beta1_VaultEnvAuth(a.(*certmanager.VaultEnvAuth), b.(*VaultEnvAuth), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_VaultEnvAuth_To_certmanager_VaultEnvAuth(in *VaultEnvAuth, out *certmanager.VaultEnvAuth, s conversion.Scope) error {
	out.Path = in.Path
	out.AdditionalData = *(*map[string]string)(unsafe.Pointer(&in.AdditionalData))
	return nil
}

// Convert_v1beta1_VaultEnvAuth_To_certmanager_VaultEnvAuth is an autogenerated conversion function.
func Convert_v1beta1_VaultEnvAuth_To_certmanager_VaultEnvAuth(in *VaultEnvAuth, out *certmanager.VaultEnvAuth, s conversion.Scope) error {
	return autoConvert_v1beta1_VaultEnvAuth_To_certmanager_VaultEnvAuth(in, out, s)
}

func autoConvert_certmanager_VaultEnvAuth_To_v1beta1_VaultEnvAuth(in *certmanager.VaultEnvAuth, out *VaultEnvAuth, s conversion.Scope) error {
	out.Path = in.Path
	out.AdditionalData = *(*map[string]string)(unsafe.Pointer(&in.AdditionalData))
	return nil
}

// Convert_certmanager_VaultEnvAuth_To_v1beta1_VaultEnvAuth is an autogenerated conversion function.
func Convert_certmanager_VaultEnvAuth_To_v1beta1_VaultEnvAuth(in *certmanager.VaultEnvAuth, out *VaultEnvAuth, s conversion.Scope) error {
	return autoConvert_certmanager_VaultEnvAuth_To_v1beta1_VaultEnvAuth(in, out, s)
}
